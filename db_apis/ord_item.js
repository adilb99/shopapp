...
const baseQuery = "select * from ord_item";
...
const deleteSql =
 `
 declare 
    cart_cont_id integer;
 begin
    
    select cart_content_history_id into cart_cont_id from ord_item where id = :id;

    delete from ord_item where id = :id;

    delete from cart_content_history
    where id = cart_cont_id;
